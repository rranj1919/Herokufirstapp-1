...
const authRest = require('./verifyToken');
const auth = require('./authLogin');
const { pool,secretKey,algorithm } = require('../config');
...
router.get('/get/:tableName', authRest, async (req, res) => {
...
// @access  Private 
router.get('/getAllTables', authRest, async (req, res) => {
...
// @access  Private 
router.get('/get', authRest, async (req, res) => { 
